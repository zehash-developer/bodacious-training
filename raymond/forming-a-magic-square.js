...
function formingMagicSquare(s) {
    ...
    let magicSquares = [[[8, 1, 6], [3, 5, 7], [4, 9, 2]], 
                       ...
                       [[4, 3, 8], [9, 5, 1], [2, 7, 6]], 
                       [[6, 7, 2], [1, 5, 9], [8, 3, 4]], 
                       [[2, 7, 6], [9, 5, 1], [4, 3, 8]],]; // All Possible 3x3 Arrays
    for(let magicIndex = 0; magicIndex < magicSquares.length; magicIndex++)
    {
        let cost = 0;
        for(let col = 0; col < s.length; col++)
        {
            ...
            {
                cost += difference(magicSquares[magicIndex][col][row],s[col][row]);
            }
        }
